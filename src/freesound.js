(function () {
    ...
    var freesound = function () {        
        ...
        var makeRequest = function (uri, success, error, params, wrapper, method, data, content_type){
            ...
            if (typeof module !== 'undefined'){ // node.js
                ...
                catch (e) {xhr = new window.ActiveXObject('Microsoft.XMLHTTP');}
    ...
    else if (typeof module === 'function' && typeof module.amd === 'object') { module("freesound", [], freesound); }
